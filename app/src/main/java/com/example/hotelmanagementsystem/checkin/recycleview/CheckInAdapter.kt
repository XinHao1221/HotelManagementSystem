package com.example.hotelmanagementsystem.checkin.recycleview
...
import com.example.hotelmanagementsystem.checkin.CheckInDetailFragment
import com.example.hotelmanagementsystem.checkin.CheckInMenuFragmentDirections
import com.example.hotelmanagementsystem.database.Reservation
import com.example.hotelmanagementsystem.hotelreservation.ReservationMenuFragmentDirections
...
class CheckInAdapter(): RecyclerView.Adapter<CheckInAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.reservation_menu_cardView.setOnClickListener{
            ...
            val action = CheckInMenuFragmentDirections.actionCheckInMenuFragmentToCheckInDetailFragment(item)
