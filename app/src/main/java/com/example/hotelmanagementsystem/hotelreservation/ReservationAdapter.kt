...
//import com.example.hotelmanagementsystem.util
...
//            .inflate(R.layout.res_text_item_list,
//                parent, false)
//        return ViewHolder(view)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.reservation_menu_cardView.setOnClickListener{
            ...
            val action = ReservationMenuFragmentDirections.actionReservationMenuFragmentToReservationDetailFragment(item)
